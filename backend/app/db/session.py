        ...
        with db_engine.connect() as conn:
            ...
            conn.execute(text("""
                UPDATE files SET category = 'image' WHERE category IS NULL AND (
                    name LIKE '%.png' OR name LIKE '%.jpg' OR name LIKE '%.jpeg'
            ...
            conn.execute(text("""
                UPDATE files SET category = 'video' WHERE category IS NULL AND (
                    name LIKE '%.mp4' OR name LIKE '%.webm' OR name LIKE '%.mov'
            ...
            conn.execute(text("""
                UPDATE files SET category = 'audio' WHERE category IS NULL AND (
                    name LIKE '%.mp3' OR name LIKE '%.wav' OR name LIKE '%.ogg'
            ...
            conn.execute(text("""
                UPDATE files SET category = 'document' WHERE category IS NULL AND (
                    name LIKE '%.pdf' OR name LIKE '%.txt' OR name LIKE '%.doc' OR name LIKE '%.docx'
